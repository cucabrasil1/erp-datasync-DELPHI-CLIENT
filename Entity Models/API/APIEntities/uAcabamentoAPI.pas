...
{ TAcabamentoAPI }
class function TAcabamentoAPI.ResourceName: string;
begin
  Result := '/acabamento';
end;


function TAcabamentoAPI.ToJson: TJSONObject;
begin
...
procedure TAcabamentoAPI.FromJson(AJson: TJSONObject);
begin
